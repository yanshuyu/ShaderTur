...
/* UNITY: Original start of shader */
        ...
        void vert(inout appdata_base v, out Input o) {
            ...
            o.uv_GrabTex = ComputeGrabScreenPos(UnityObjectToClipPos(v.vertex));
        }

        void surf(Input i, inout SurfaceOutput o) {
            half3 diffuse = tex2D(_MainTex, i.uv_MainTex).rgb * _Color.rgb;
            half2 uvDistortion = UnpackNormal(tex2D(_BumpTex, i.uv_MainTex)).xy * _DistoreAmount;
            //i.uv_GrabTex.xy += uvDistortion;
            half3 bgCol = tex2D(_GrabTex,i.uv_GrabTex.xy).rgb;
...
struct v2f_surf {
  UNITY_POSITION(pos);
  float4 pack0 : TEXCOORD0; // _GrabTex
...
v2f_surf vert_surf (appdata_base v) {
  ...
  o.pack0.xyzw = TRANSFORM_TEX(v.texcoord, _GrabTex);
...
fixed4 frag_surf (v2f_surf IN) : SV_Target {
  ...
  surfIN.uv_GrabTex.x = 1.0;
  surfIN.uv_GrabTex = IN.pack0.xyzw;
